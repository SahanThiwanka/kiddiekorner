...
public class ActivitySquare extends AppCompatActivity {
    ...
    ConstraintLayout btnred, btngreen, btnblue, btnnext;
    ImageView img;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hexagon_color);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ActivitySquare.this,ActivitySquareChange.class);
